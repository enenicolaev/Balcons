...
/* harmony import */ var _modules_imgModal__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/imgModal */ "./src/js/modules/imgModal.js");
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  Object(_modules_modal__WEBPACK_IMPORTED_MODULE_1__["default"])(".popup_calc_btn", ".popup_calc", ".popup_calc_close", timerModal, true);
  Object(_modules_modal__WEBPACK_IMPORTED_MODULE_1__["default"])(".popup_calc_button", ".popup_calc_profile", ".popup_calc_profile_close", timerModal, false);
  Object(_modules_modal__WEBPACK_IMPORTED_MODULE_1__["default"])(".popup_calc_profile_button", ".popup_calc_end", ".popup_calc_end_close", timerModal, false);
  Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_2__["default"])(".glazing_block", ".glazing_content", "block", "active");
  Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_2__["default"])(".decoration_item", ".decoration_content > .row > div", "block", "active", "after_click"); // tavs for calc modal

  Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_2__["default"])(".balcon_icons_img", ".big_img > img", "inline-block", "do_image_more");
  Object(_modules_forms__WEBPACK_IMPORTED_MODULE_3__["default"])('form', 'input', modalState);
  Object(_modules_changeModalState__WEBPACK_IMPORTED_MODULE_4__["default"])(modalState); // timer

  Object(_modules_timer__WEBPACK_IMPORTED_MODULE_5__["default"])(".container1", deadline); // modal Img

  Object(_modules_imgModal__WEBPACK_IMPORTED_MODULE_6__["default"])(".works");
});
...
function forms(formSelector, inputSelector, data) {
  ...
  Object(_checkNumInputs__WEBPACK_IMPORTED_MODULE_5__["default"])("".concat(inputSelector, "[name=\"user_phone\"]"));
    ...
    formsArray.forEach(function (item) {
      item.addEventListener("submit", function (e) {
        ...
        postData("assets/server.php", formData).then(function (res) {
          console.log(res);
          statusMessage.textContent = messages.success; //document.querySelector(".status").textContent = messages.success;
        }).catch(function () {
          statusMessage.textContent = messages.fail; //document.querySelector(".status").textContent = messages.fail;
        }).finally(function () {
          clearinputs();
          setTimeout(function () {
...
function imgModal(imgParentSelecor) {
  var parentElem = document.querySelector(imgParentSelecor),
...
/*!*********************************!*\
  !*** ./src/js/modules/modal.js ***!
  \*********************************/
/*! exports provided: default, openModal, closeModal, closeAllModals */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/web.dom-collections.for-each */ "./node_modules/core-js/modules/web.dom-collections.for-each.js");
/* harmony import */ var core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _validateCalcForm__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./validateCalcForm */ "./src/js/modules/validateCalcForm.js");
...
function openModal(modal, timer) {
  ...
  document.body.style.overflow = "hidden";
  document.body.style.marginRight = "".concat(calcScrollIndent, "px");
  clearInterval(timer);
}
...
function closeAllModals(modalsArray) {
  modalsArray.forEach(function (item) {
...
function modal(triggerSelector, modalSelector, closeSelector, timerModal) {
  var closeAbility = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : true;
  var triggers = document.querySelectorAll(triggerSelector),
      modal = document.querySelector(modalSelector),
      closeBtn = document.querySelector(closeSelector); // object with all Modal Selector's

  var modalsArray = document.querySelectorAll("[data-modal]");

  function bindOpenTriggers() {
    triggers.forEach(function (item) {
      item.addEventListener("click", function (e) {
        e.preventDefault(); // validate calc Modals 

        switch (modalSelector) {
          case ".popup_calc_profile":
            if (Object(_validateCalcForm__WEBPACK_IMPORTED_MODULE_1__["default"])(item, _main__WEBPACK_IMPORTED_MODULE_2__["modalState"], "form", "width", "height")) {
          ...
          case ".popup_calc_end":
            if (Object(_validateCalcForm__WEBPACK_IMPORTED_MODULE_1__["default"])(item, _main__WEBPACK_IMPORTED_MODULE_2__["modalState"], "form", "width", "height", "profile", "type")) {
              closeAllModals(modalsArray);
              openModal(modalSelector, timerModal);
            }
...
function tabs(tabsSelector, tabsContentSelector, display) {
  for (var _len = arguments.length, activeClass = new Array(_len > 3 ? _len - 3 : 0), _key = 3; _key < _len; _key++) {
    activeClass[_key - 3] = arguments[_key];
  }
...
/***/ "./src/js/modules/validateCalcForm.js":
/*!********************************************!*\
  !*** ./src/js/modules/validateCalcForm.js ***!
  \********************************************/
/*! exports provided: default */
...
var validateCalcForm = function validateCalcForm(submitSelector, data) {
  ...
  for (var _len = arguments.length, arrayRequiredParams = new Array(_len > 2 ? _len - 2 : 0), _key = 2; _key < _len; _key++) {
    arrayRequiredParams[_key - 2] = arguments[_key];
  }

  arrayRequiredParams.forEach(function (prop) {
    if (!data[prop]) {
...
/* harmony default export */ __webpack_exports__["default"] = (validateCalcForm);
